...
const opts: SotaTableProps<CountryEntry> = {
    ...
    columns: [
        ...
        (<Table.Column key="country" dataIndex="country" render={(c: string) => (
            <Tooltip className="font-body" title={getCountryName(c)} placement="left">
        ...
        (<Table.Column key="total" dataIndex="total" title={
            <span className="text-bold font-primary">Total</span>
        } align="center" />),
